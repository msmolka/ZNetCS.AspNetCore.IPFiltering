// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IPAddressParser.cs" company="Marcin Smółka zNET Computer Solutions">
...
public static class IPAddressParser
{
    ...
    public static IPAddress? Parse(string address)
    {
        ...
        if (address.StartsWith("[", StringComparison.Ordinal))
        {
            ...
            return IPAddress.TryParse(address[..(end + 1)], out ipAddress) ? ipAddress : null;
        }
        ...
        {
            return IPAddress.TryParse(address[..end], out ipAddress) ? ipAddress : null;
        }
