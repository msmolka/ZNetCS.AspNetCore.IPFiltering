// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StartupPathAllow.cs" company="Marcin Smółka zNET Computer Solutions">
...
namespace ZNetCS.AspNetCore.IPFilteringTest
{
    ...
    public class StartupPathAllow
    {
        ...
        /// </param>
#if NETCOREAPP3_0
        public StartupPathAllow(IWebHostEnvironment env)
#else
        public StartupPathAllow(IHostingEnvironment env)
#endif
        {
            IConfigurationBuilder builder = new ConfigurationBuilder()
                .SetBasePath(env.ContentRootPath)
                .AddJsonFile("appsettingsPathAllow.json", true, true)
