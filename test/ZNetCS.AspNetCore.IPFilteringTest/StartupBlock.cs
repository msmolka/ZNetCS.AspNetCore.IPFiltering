...
namespace ZNetCS.AspNetCore.IPFilteringTest
{
    ...
    public class StartupBlock
    {
        ...
        /// </param>
#if NETCOREAPP3_0
        public StartupBlock(IWebHostEnvironment env)
#else
        public StartupBlock(IHostingEnvironment env)
#endif
        {
            IConfigurationBuilder builder = new ConfigurationBuilder()
                .SetBasePath(env.ContentRootPath)
                .AddJsonFile("appsettingsBlock.json", optional: true, reloadOnChange: true)
